...
if __name__ == '__main__':
    ...
    unic_name_rstom,l = get_try_dataset(main_path, fnameTRY, plant_species, 1)
    unic_name_vcmax,v = get_try_dataset(main_path, fnameTRY, plant_species, 2)
